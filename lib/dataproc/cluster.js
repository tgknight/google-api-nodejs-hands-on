...
class Cluster {
  ...
  create(clusterConfig) {
    ...
    return new Promise((resolve, reject) => {
      this.auth.authenticate()
        .then(auth => this.dataproc.projects.regions.clusters.createAsync(extend(params, { auth })))
  ...
  get() {
    ...
    return new Promise((resolve, reject) => {
      this.auth.authenticate()
        .then(auth => this.dataproc.projects.regions.clusters.getAsync(extend(params, { auth })))
        .then(res => resolve(res))
        .catch(err => reject(err))
    })
  }
  ...
  update(clusterConfig) {
    ...
    return new Promise((resolve, reject) => {
      this.auth.authenticate()
        .then(auth => this.dataproc.projects.regions.clusters.patchAsync(extend(params, { auth })))
        .then(res => resolve(res))
        .catch(err => reject(err))
    })
  }
  ...
  delete() {
    ...
    return new Promise((resolve, reject) => {
      this.auth.authenticate()
        .then(auth => this.dataproc.projects.regions.clusters.deleteAsync(extend(params, { auth })))
        .then(res => resolve(res))
        .catch(err => reject(err))
    })
  }
  ...
  list(region) {
    ...
    return new Promise((resolve, reject) => {
      this.auth.authenticate()
        .then(auth => this.dataproc.projects.regions.clusters.listAsync(extend(params, { auth })))
        .then(res => resolve(res))
        .catch(err => reject(err))
    })
  }
