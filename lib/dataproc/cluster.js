 ...
 * @param {object} config.clientConfig - OAuth2 configuration of the clientConfig
 * @param {object} config.credentials - OAuth2 generated access keys
...
class Cluster {
  constructor(config) {
    console.log(config)
    this.config = config
    this.auth = new Auth(this.config.clientConfig, this.config.credentials)
