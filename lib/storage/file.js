...
class File {
  ...
  upload (localPath) {
    ...
    return new Promise((resolve, reject) => {
      this.storage.objects.insertAsync(params)
  ...
  combine(components) {
    ...
    return new Promise((resolve, reject) => {
      this.storage.objects.composeAsync(params)
        .then((res) => resolve(res))
        .catch(err => reject(err))
    })
  }
  ...
  deleteFolder () {
    ...
    return new Promise((resolve, reject) => {
      this.storage.objects.getAsync(params)
        .then(() => this.storage.objects.listAsync(params))

        // must delete everything inside the folder first
